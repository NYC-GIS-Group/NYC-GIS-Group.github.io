...
$('.download').click(function(){
  ...
  var queryTemplate = 'https://imorey.carto.com/api/v2/sql?format={{type}}&filename=acs_dl&q=SELECT the_geom{{fields}} FROM census_2010_tracts_merge a WHERE ST_INTERSECTS({{{intersects}}}, a.the_geom)';
